...
import 'your_csv_provider.dart';
import 'your_csv_results.dart';

import 'dart:typed_data';

class YourCSVModelTrained extends StatefulWidget {
  YourCSVModelTrained({@required this.trainedData, this.pickedFile});
  final trainedData;
  final pickedFile;
  @override
  _YourCSVModelTrainedState createState() => _YourCSVModelTrainedState();
}

class _YourCSVModelTrainedState extends State<YourCSVModelTrained> {
  YourCSVProvider viewProvider = YourCSVProvider();
  @override
  Widget build(BuildContext context) {
    final fairnessAnalysis = widget.trainedData["fairness_analysis"];
    return Scaffold(
      backgroundColor: Colors.white,
      appBar: MyAppBar(),
      body: FutureBuilder(
          future: yourCSVconfusionMatrix(widget.pickedFile),
                            ...
                            child: ListTile(
                              ...
                              trailing: Padding(
                                ...
                                child: ElevatedButton(
                                    onPressed: () {
                                      viewProvider.trainingScore(
                                          fairnessAnalysis['get_ts']
                                              .toString());
                                    },
                          ...
                          Container(
                            ...
                            child: ListTile(
                              ...
                              trailing: Padding(
                                ...
                                child: ElevatedButton(
                                    onPressed: () {
                                      viewProvider.accuracy(
                                          fairnessAnalysis['get_accuracy']
                                              .toString());
                                    },
                                    child: Icon(Icons.play_arrow)),
                              ),
                        ...
                        child: Container(
                          ...
                          child: ListTile(
                            ...
                            trailing: Padding(
                              ...
                              child: ElevatedButton(
                                  onPressed: () {
                                    viewProvider.classificationReport(
                                        fairnessAnalysis['report'].toString());
                                  },
                                  child: Icon(Icons.play_arrow)),
                            ),
                          ),
                      ...
                      Padding(
                        ...
                        child: Align(
                          child: ElevatedButton(
                            ...
                            onPressed: () async {
                              Get.to(YourCSVResults(
                                data: widget.trainedData,
                              ));
                            },
                            child: Text(
