...
import 'census_results.dart';
import 'dart:typed_data';

class CensusModelTrained extends StatefulWidget {
  CensusModelTrained({required this.trainedData});
  final Map<String, dynamic> trainedData;
  @override
  _CensusModelTrainedState createState() => _CensusModelTrainedState();
}

class _CensusModelTrainedState extends State<CensusModelTrained> {
